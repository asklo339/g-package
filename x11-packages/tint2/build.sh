...
TERMUX_PKG_DEPENDS="gdk-pixbuf, glib, gtk3, imlib2, libposix-shm, libandroid-wordexp, libcairo, librsvg, libx11, libxcomposite, libxdamage, libxext, libxinerama, libxrandr, libxrender, pango, startup-notification"
