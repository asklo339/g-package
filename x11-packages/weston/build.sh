...
TERMUX_PKG_DEPENDS="freerdp, libaml, libposix-shm, libcairo, libcairo, libevdev, libglvnd, libneatvnc, libseat, libwayland, libwebp, libxcb, libxcursor, libxkbcommon, littlecms, pango, xcb-util-cursor"
