...
TERMUX_PKG_DEPENDS="freetype, gdk-pixbuf, giflib, glib, libposix-shm, libbz2, libcairo, libheif, libid3tag, libjpeg-turbo, libjxl, liblzma, libpng, librsvg, libtiff, libwebp, libx11, libxcb, libxext, openjpeg, zlib"
