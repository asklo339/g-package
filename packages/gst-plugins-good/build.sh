...
TERMUX_PKG_DEPENDS="glib, gst-plugins-base, gstreamer, libposix-shm, libbz2, libcaca, libflac, libjpeg-turbo, libmp3lame, libnettle, libpng, libvpx, libx11, libxext, libxfixes, libxml2, mpg123, pulseaudio, zlib"
