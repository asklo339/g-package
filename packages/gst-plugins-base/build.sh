...
TERMUX_PKG_DEPENDS="glib, graphene, gstreamer, libposix-shm, libjpeg-turbo, libogg, libopus, libpng, libtheora, libvorbis, libx11, libxcb, libxext, libxi, libxv, zlib"
